...
<head>
  ...
  <title>Zatvaranje sjedala</title>
...
<body>
  ...
  <h2>Zatvaranje sjedala na letovima avio tvrtke</h2>
  <p>Zatvaraju se sjedala na letovima avio tvrtke kojoj ste zastupnik u zadanom intervalu datuma.</p>

  <c:if test="${not empty poruka}">
    <p><strong>${poruka}</strong></p>
  </c:if>

  <form method="post" action="${pageContext.servletContext.contextPath}/mvc/aviotvrtke/zatvaranjeSjedala">
