  ...
  <p>
    <c:choose>
      <c:when test="${mozeUskladiti}">
        <a href="${pageContext.servletContext.contextPath}/mvc/rezervacije/uskladiRacun/${racun.id}">Uskladi broj stavki računa sa stvarnim brojem</a>
      </c:when>
      <c:otherwise>
